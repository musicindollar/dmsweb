...
<?php
require "../../header.php";
$title = "Previous season archive: 2019-20";
htmlHead($title);
?>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <ul class="list-group">
                ...
                <li class="clearfix list-group-item dms-list-item-prev" id="ChristinaLawrie">
                    <div class="col-sm-3">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <p>Due to Covid19 the Roxburgh Quartet concert was unable to go ahead.</p>
            <p>It will be rescheduled for season 21/22, or as soon as possible thereafter once public concerts are
                possible. </p>
        </div>
    </div>
    <div class="row">
