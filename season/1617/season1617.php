...
<div class="container-fluid">
    ...
    <div class="row page-header">
        <div class="col-sm-12">
            ...
            the full programme for the 2016-17 season [PDF 3.5MB] <a
    ...
    <div class="row">
        <div class="col-sm-12">
            <ul class="list-group">
                ...
                <li class="clearfix list-group-item dms-list-item-prev">
                    <div class="col-sm-3">
                        <h3>Dollar&#39;s got talent</h3>
                        <h4 class="text-info">
                            Thursday, 11<span class="subscript">th</span> May 2017
                        </h4>
                        <p>7:30pm Burnside Hall, Dollar <a
                    ...
                    <div class="col-sm-6">
                        <p>Our Members evening will feature a range of talented student musicians - something for
                            everybody!
                        <p>Seven young musicians will showcase their talents on clarinet, violin, piano and voice.</p>
                        <p>Enjoy the music and chat in an informal setting. Cabaret style tables, drinks and nibbles
                            provided. A short AGM is included.
                        </p>
                    </div>
                </li>
