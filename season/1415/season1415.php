...
<?php
require "../../header.php";
$title = "Previous season archive: 2014-15";
htmlHead($title);
?>
...
<div class="container-fluid">
    ...
    <div class="row page-header">
        <div class="col-sm-12">
            <a href="/season/1415/DMS-Leaflet-2014-15.pdf" target="_blank">View</a> the full
            programme for season 2014-15 [PDF 3.6Mb] <a href="/season/1415/DMS-Leaflet-2014-15.pdf" target="_blank"><img
        ...
        <div class="col-sm-12">
            <ul class="list-group">
                ...
                <li class="clearfix list-group-item dms-list-item-prev">
                    ...
                    <div class="col-sm-6">
                        <p>Outstanding young local jazz pianist Fergus McCreadie will show us why he won young Scottish
                            jazz musician two years running!</p>
                        <p>A short AGM will accompany the recital.</p>
                        <a href="http://www.fergusmccreadiejazzpiano.com/" target="_blank">More about Fergus
                            McCreadie</a>
                    </div>
                </li>
