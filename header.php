            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown <?php if ($tag == "archive") echo "active"; ?>"><a
                    ...
                    <ul class="dropdown-menu">
                        <li class="<?php if ($tag == "archive2526") echo "active"; ?>"><a
                                    href="/season/2526/season2526.php">Season 2025-26</a></li>
                        <li class="<?php if ($tag == "archive2425") echo "active"; ?>"><a
                                    href="/season/2425/season2425.php">Season 2024-25</a></li>
