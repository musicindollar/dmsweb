...
<!--                  <a href="https://twitter.com/MusicInDollar" target="_blank">Twitter</a>.</p>-->
    ...
    <div id="NextConcert" class="row">
      <div class="col-sm-12">
          ...
          <ul class="list-group">
            <li class="clearfix list-group-item dms-list-item-next" id="OpenAfternoon">
              <div class="col-sm-3">
              ...
              <div class="col-sm-6">
                <p>In a change of format, our event to open the new season is an afternoon of music.</p>
    ...
    <div class="row">
      <div class="col-sm-12">
        <ul class="list-group">
          ...
          <li class="clearfix list-group-item dms-list-item" id="NightAtTheOpera">
            <div class="col-sm-3">
...
<!--              <p>Pre-concert performance from 2:45pm</p>-->
            ...
            <div class="col-sm-6">
              ...
              <p>Including Eddie McGuire (of Whistlebinkies fame, and a prominent composer) who introduces the pieces.
                This is an informal event, where the audience are invited to touch and play the instruments and chat
                to the performers!
              </p>
            </div>
          </li>
