            ...
            <div class="col-sm-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <p><span class="fa fa-music"></span> Great to hear the Roxburgh Quartet after such a long wait.
                            The Schubert was a gripping epic!
                        </p>
    ...
    <div class="row">
        <div class="col-sm-12">
            <ul class="list-group">
                ...
                <li class="clearfix list-group-item dms-list-item-next" id="PRDuo">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-12">
                        <ul class="list-group">
                            ...
                            <li class="clearfix list-group-item dms-list-item" id="ClareHammond">
                                ...
                                <div class="col-sm-6">
                                    <p>Clare Hammond is an English pianist. Widely broadcast and recorded, she has
                                        created a strong
                                        reputation as a 'star' interpreter of several areas, including contemporary
                                        music.
                                    ...
                                    <p>Acclaimed as a pianist of “amazing power and panache” <i>(The Telegraph)</i>,
                                        Clare Hammond
                                        is
                                        recognised for the virtuosity and authority of her performances and has
                                        developed a
                                        “reputation for brilliantly imaginative concert programmes” <i>(BBC Music
                                            Magazine)</i>. In
                                        2016,
                                        she won the Royal Philharmonic Society's 'Young Artist Award' in recognition of
                                        outstanding
                                        achievement and in 2020 she was engaged to perform at the International Piano
                                        Series
