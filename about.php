...
?>
		...
		<div id="Membership" class="row">
			<div class="col-sm-12">
				...
				<p>This year we have introduced a new, simple flat-rate membership.
		...
		<div id="Dollar" class="row">
			<div class="col-sm-6">
				...
				<p>
					The name Dollar has nothing to do with <a href="http://en.wikipedia.org/wiki/Dollar">money or silver</a>! It is
				...
				<p>
					...
					It was the lowland seat of the <a href="en.wikipedia.org/wiki/Duke_of_Argyll">Duke of Argyll</a>. In recent times
					Dollar has been closely associated with <a href="http://dollaracademy.org/">Dollar Academy</a>, with its
					magnificent Greek influenced <a href="http://en.wikipedia.org/wiki/William_Henry_Playfair">Playfair</a> building.
				</p>
				<p>
